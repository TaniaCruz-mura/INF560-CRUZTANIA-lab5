        ...
        <form class="bg-white rounded shadow-sm p-6 space-y-4">
            <div>
                ...
                <input type="text" disabled placeholder="Ej. Cien años de soledad"
                       class="w-full border border-slate-300 rounded px-3 py-2 bg-slate-100 text-slate-500">
            </div>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    <label class="block text-sm font-medium text-slate-700 mb-1">Año de publicación</label>
            ...
            <div>
                ...
                <select disabled class="w-full border border-slate-300 rounded px-3 py-2 bg-slate-100">
            ...
            <div>
                ...
                <textarea disabled rows="4"
                          class="w-full border border-slate-300 rounded px-3 py-2 bg-slate-100"></textarea>
            </div>
